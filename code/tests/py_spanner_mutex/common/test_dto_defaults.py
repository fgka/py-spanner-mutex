...
_TEST_MY_HAS_PATCH_WITH_SUBSTITUTION = _MyHasPatchWith_Substitution(field_int=11, field_str="TEST_SUBSTITUTION")
...
class _MyHasPatchWith_Merge_Subclass(_MyHasPatchWith_Merge):
    field_int: str = attrs.field(default=None, validator=attrs.validators.instance_of(str))
...
class _MyHasPatchWith_Merge_Recursion_A(dto_defaults.HasPatchWith):
    field_with_patch: dto_defaults.HasPatchWith = attrs.field(
        default=None,
        validator=attrs.validators.optional(attrs.validators.instance_of(dto_defaults.HasPatchWith)),
    )


@attrs.define(**const.ATTRS_DEFAULTS)
class _MyHasPatchWith_A(dto_defaults.HasPatchWith):
    field_value: Optional[int] = attrs.field(
        default=None,
        validator=attrs.validators.optional(attrs.validators.instance_of(int)),
    )
...
_TEST_MY_HAS_PATCH_WITH_MERGE_B = _MyHasPatchWith_Merge(field_int=17, field_with_patch=_TEST_MY_HAS_PATCH_WITH_MERGE_A)
...
_TEST_MY_HAS_PATCH_WITH_MERGE_REDEFINED_FIELD_TYPE_SUBCLASS_A = _MyHasPatchWith_Merge_Recursion(
    field_with_patch=_TEST_MY_HAS_PATCH_WITH_A
)
_TEST_MY_HAS_PATCH_WITH_B = _MyHasPatchWith_B(field_value="37")
_TEST_MY_HAS_PATCH_WITH_MERGE_REDEFINED_FIELD_TYPE_SUBCLASS_B = _MyHasPatchWith_Merge_Recursion(
    field_with_patch=_TEST_MY_HAS_PATCH_WITH_B
)
...
class TestHasPatchWith_Merge:
    def test_patch_with_ok_return_self(self):
        # Given
        obj = _MyHasPatchWith_Merge(field_int=23, field_with_patch=_TEST_MY_HAS_PATCH_WITH_SUBSTITUTION)
        # When
    ...
    def test_patch_with_ok_recursion(self):
        # Given
        obj = _MyHasPatchWith_Merge(
            field_with_patch=_MyHasPatchWith_Merge(field_with_patch=_TEST_MY_HAS_PATCH_WITH_SUBSTITUTION)
        )
        value = _MyHasPatchWith_Merge(field_int=29, field_with_patch=_MyHasPatchWith_Merge(field_int=31))
        # When
